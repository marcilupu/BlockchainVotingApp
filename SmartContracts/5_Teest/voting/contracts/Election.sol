...
contract Election {
    ...
    event AddCandidateEvent(address sender, uint candidateId);
    event CastVoteEvent(address sender, uint voterProof, uint candidateId);
    ...
    function addCandidate(uint candidateId) public {
        ...
        emit AddCandidateEvent(msg.sender, candidateId);
    }
    ...
    function castVote(uint256 ax, uint256 ay, uint256 bx0, uint256 bx1, uint256 by0, uint256 by1, uint256 cx, uint256 cy, uint256 proofSha, uint candidateId) public returns (bool){
        ...
        {        
            ...
            emit CastVoteEvent(msg.sender, proofSha, candidateId);
