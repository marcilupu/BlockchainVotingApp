...
namespace BlockchainVotingApp.SmartContract.Models
{
    ...
    /// </summary>
    public sealed class VotingProof
    {
        public VotingProof() { }

        /// <summary>
        /// Attempt to read a new instance of <see cref="VotingProof"/> from a zokrates proof.json file.
        /// </summary>
        public static bool TryRead(string proofFile, [NotNullWhen(true)] out VotingProof? proof)
        {
            proof = null;
